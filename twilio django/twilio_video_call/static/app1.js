...
const get_photo = document.getElementById('Photo');
...
function fn_get_photo(event){
    ...
    canvas.width = check_video.videoWidth;
    canvas.height = check_video.videoHeight;
    contexto.drawImage(check_video, 0, 0, canvas.width, canvas.height);
...
get_photo.addEventListener('click', fn_get_photo)
